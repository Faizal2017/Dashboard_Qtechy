...
return (
  <div className="bg-white p-6 rounded-xl shadow-xl mt-10 space-y-8 border border-gray-200">
    <h2 className="text-3xl font-bold text-indigo-600 mb-2">🛠️ Dashboard Settings</h2>

    {/* Header Title */}
    <div className="space-y-2">
      <label className="block text-gray-700 font-semibold">Header Title</label>
      <input
        type="text"
        value={header.title}
    ...
    {/* Image Upload */}
    <div className="space-y-2">
      <label className="block text-gray-700 font-semibold">Header Image</label>
      <input
        type="file"
